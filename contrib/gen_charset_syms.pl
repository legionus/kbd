...
my $keysyms = {
    ...
    "cyrillic_small_letter_ghe_with_upturn" => "ukrainian_cyrillic_small_letter_ghe_with_upturn",
    ...
    "cyrillic_capital_letter_ghe_with_upturn" => "ukrainian_cyrillic_capital_letter_ghe_with_upturn",
