...
int
writepsffontheader(FILE *ofil, size_t width, size_t height, size_t fontlen, int *psftype, int flags)
{
...
int writepsffont(FILE *ofil, char *fontbuf, size_t width, size_t height, size_t fontlen,
